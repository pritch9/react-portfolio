...
export const RemovedJobExperience: JobInfo[] = [
	{
		...
		bullets: [
			'Develop UB’s ﬂavor of the Selenium WebDriver using test-driven development',
...
const RemovedProjects: ProjectInfo[] = [
	{
		title: 'Coursarium',
		role: 'Lead',
		date: {
		...
		bullets: [
			'Coursework submission for easy grading, feedback, record-keeping, and student analytics',
